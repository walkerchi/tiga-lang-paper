...
\begin{figure}[htbp]
\centering
\input{figures/storage-hierarchy}
...
A logical device mesh and destination partition assign output ownership.
Remote source values become ghosts, and a halo map specifies transfers between
ranks. The public schedule completes halo exchange before computing all owned
