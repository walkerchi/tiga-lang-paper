...
Appendix~\ref{app:edge-nn}; Appendix~\ref{app:attention} expresses causal attention
with the same graph, edge and reducer interface. Compiler and runtime development is covered in
